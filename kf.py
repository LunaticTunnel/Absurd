...
def about():
    ...
    print(f"{cyan}[Author]    {purple} :[LunaticTunnel]")
    print(f"{cyan}[Github]    {purple} :[https://github.com/LunaticTunnel]")
    print(f"{cyan}[Messenger] {purple} :[https://wa.me/6282240074362]")
    print(f"{cyan}[Email]     {purple} :[vpnscript293@gmail.com]\n")
    ...
    while True:
        if choose == "1" or choose=="01":
            ...
            if os.path.exists("/data/data/com.termux/files/home"):
                os.system("xdg-open --view 'https://github.com/LunaticTunnel/LunaticTunnel#My-Best-Works'")
            else:
                os.system("xdg-open 'https://github.com/LunaticTunnel/LunaticTunnel#My-Best-Works'")
            main()
